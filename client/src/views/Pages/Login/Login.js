                    ...
                    <Form noValidate onSubmit={this.onSubmit}>
                      ...
                      <Row>
                        <Col xs="12 text-left">
                          ...
                          <Button color='secondary' className="btn-twitter nuslogin" ><a href='https://mypal-app.herokuapp.com/auth/nus' className='NUS'><i className='fa fa-user mr-2'></i> NUS Login</a></Button>
