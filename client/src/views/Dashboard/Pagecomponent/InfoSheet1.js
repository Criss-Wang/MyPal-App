...
export class InfoSheet extends Component {
  ...
  togglesubmit(){
    ...
    axios.put(`contacts/${localStorage.contactId}/updatecontact/${this.state.id}`, info)
    .then(res => {
                ...
                <Col lg='6' xs='6'  className='pl-4 pr-3'>
                  ...
                  <Row className='pb-0 mb-0'>
                    ...
                    <Col md='3' className='text-center mt-3'>
                        ...
                        <Input type='file' name="file" id="img" className='inputhere' onChange={this.uploadImage}/>
